...
var (
	...
	// 命令行参数
	listenAddr  = flag.String("web.listen-port", utils.GetEnvWithDefault("PORT","9001"), "An port to listen on for web interface and telemetry.")
	metricsPath = flag.String("web.telemetry-path", "/metrics", "A path under which to expose metrics.")
	metricsNamespace = flag.String("metric.namespace", "mysql", "Prometheus metrics namespace, as the prefix of metrics name")
)
